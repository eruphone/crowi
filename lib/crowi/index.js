...
Crowi.prototype.setupSessionConfig = function() {
  ...
  var sessionConfig
  var sessionAge = 1000 * 3600 * 24 * 30
  var redisUrl = this.env.REDISTOGO_URL || this.env.REDIS_URL || null
  var RedisStore
...
Crowi.prototype.start = function() {
  ...
  return self.buildServer().then(function(app) {
